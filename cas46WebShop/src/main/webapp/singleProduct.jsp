...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    ArticleHelper article = (ArticleHelper)request.getAttribute("article");
  //  out.println(article);
        ...
        <li class="nav-item">
              ...
              <li class="nav-item"><button><i class="ti-shopping-cart"></i><span class="nav-shop__circle"><%= cartList.size() %></span></button> </li>
               ...
               <li class="nav-item"><button><i class="ti-shopping-cart"></i><span class="nav-shop__circle">0</span></button> </li>
                  ...
                  <% } %>
              </a>              <li class="nav-item"><a class="button button-header" href="#">Buy Now</a></li>
            </ul>
          </div>
        </div>
      </nav>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="images/<%= article.getImage() %>" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2><%= article.getPrice() %> &euro;</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock (<%= article.getStockNumber() %>)</a></li>
						</ul>
						<p><%= article.getDesc() %> </p>
						<div class="">
              <label for="qty">Quantity:</label>
            
							<form action="ArticleController" method="get">
							<input type="text" name="qty" id="sst" size="2" maxlength="12" value="1" title="Quantity:" class="input-text qty">	
							<input type="hidden" name="articleId" value="<%= article.getId() %>">		
                                <button type="submit" name="action" value="formAddToCart" class="button button-tracking" style="margin-left:10px;">Add To Cart</button>
              				</form>
