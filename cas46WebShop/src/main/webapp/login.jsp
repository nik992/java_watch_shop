			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="UserController" id="contactForm" method="post">
							...
							<div class="col-md-12 form-group">
								<button type="submit" name="action" value="LogIn" class="button button-login w-100">Log In</button>
							</div>
						</form>
					</div>
				</div>
